...
public class FileManager {
	...
	public static String[] saveMultiFile(HttpServletRequest request, Product product)  throws UploadException{
		String saveDir=request.getServletContext().getRealPath("/resources/data"); // 파일 저장경로 
...
//		// jsp 였다면 application 내장객체로 해결가능하겠으나, 현재는 그냥 스프링의 컨트롤러 일뿐이다...
//		// 해결책 ????  내장객체 자료형 request - HttpServletRequest, session - HttpSession, application - ServletContext
